      ...
      {faqs.map((faq, index) => (
        <Accordion
          ...
          sx={{
            ...
            margin: 0,
            "&.Mui-expanded": {
              margin: 0, // убираем margin в раскрытом состоянии
            },
            "& .MuiAccordionSummary-content.Mui-expanded": {
              margin: "12px 0", // добавляем отступы в раскрытом состоянии,
            },
          }}>
          <AccordionSummary
            expandIcon={
          ...
          <AccordionDetails
            className='custom-accordeon-details'
            sx={{ boxShadow: "none", padding: "0", paddingBottom: "20px", transition: "all 0.5s ease" }}>
            <Typography className='faq-answer' sx={{ color: "#7F6FA4", transition: "all 0.5s ease" }}>
              {faq.answer}
            </Typography>
          </AccordionDetails>
        </Accordion>
