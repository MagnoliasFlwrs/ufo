...
const ExperiencePromoBanner = ({ onNext }) => {
    const data = [
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', padding: '24px 0' }}>
                <Typography
                    variant="h2"
                    sx={{ color: '#241063', fontSize: '24px', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '30px' }}
                >
            ...
            >Building a plan{dots}</Typography>
        </Box>
    );
};

export default ExperiencePromoBanner;
