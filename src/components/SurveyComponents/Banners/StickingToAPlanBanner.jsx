...
const StickingToAPlanBanner = ({onNext}) => {
    return (
        <Box
            sx={{
                display: "flex",
        ...
        >
            ...
            >
                <Typography variant='h2' sx={{color:'#241063' , fontSize:'24px' , fontWeight: '500' , display:'flex' , alignItems: 'center' , gap: '8px' , marginBottom:'30px'}}>
...
export default StickingToAPlanBanner;