...
import PreferencesBannerCaloryItem from '@components/SurveyComponents/Banners/PreferencesBannerCaloryItem.jsx';

const PreferencesBanner = ({ onNext }) => {
    const data = [
        {
            id: '1',
    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', gap: '20px', padding: '16px 0' }}>
                ...
                <PreferencesBannerCaloryItem
                    name="carbs"
                    gr={currentSlide.carbs.gr}
                    percent={currentSlide.carbs.percent}
                />
                <PreferencesBannerCaloryItem
                    name="fat"
                    gr={currentSlide.fat.gr}
                    percent={currentSlide.fat.percent}
                />
            </Box>

            <Box sx={{ flexGrow: 1, width: '100%', position: 'relative' }}>
                <img
                    style={{ objectPosition: 'left bottom', width: '100%', height: '100%', objectFit: 'contain' }}
